...
import AddProjectPost from "../Posts/AddProjectPost";
import { Navigate, useNavigate } from "react-router-dom";

export default function MyProjectPosts() {
  const breadcrumbs = [
  ...
  React.useEffect(() => {
    axios
      .get("https://developershubbackend.herokuapp.com/MyPosts", {
        headers: {
